...
const GLOBAL_HOOK_IDS: [&'static str; 1] = ["true"];
const SENSOR_IDS: [&'static str; 1] = ["camera"];
...
async fn generate_graph(hook_ids: HashMap<String, String>) -> Graph {
    ...
    let interval_modules = vec![
        ("true", 10),  // mimic manual spawning as an interval
    ];
...
async fn main() -> Result<(), Box<dyn Error>> {
    ...
    let matches = App::new("True pipeline")
